          ...
          <div className="prose prose-lg max-w-none space-y-8 font-cormorant">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-6 rounded-xl mt-8">
                ...
                <p>Email us at: <a href="mailto:jewelrybyluna.official@gmail.com" className="text-accent hover:text-primary transition-colors">jewelrybyluna.official@gmail.com</a></p>
