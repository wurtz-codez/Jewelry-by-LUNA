...
const RefundAndReturnPolicies = () => {
  ...
  return (
    <div className="returns-page bg-white">
      <Navbar />
      <div className="page-container">
        {/* Terms and Conditions Section */}
        <div className="mx-3 sm:mx-8 md:mx-16 lg:mx-32 mt-20 sm:mt-16 md:mt-20">
          <div className="mb-6 sm:mb-8 flex items-center justify-center gap-2 sm:gap-4 md:gap-8">
            <div className="w-12 sm:w-24 md:w-40 lg:w-60 h-0.5 md:h-1 bg-primary"></div>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-cinzel text-primary text-center">Returns & Giggles – Luna Style!</h2>
            <div className="w-12 sm:w-24 md:w-40 lg:w-60 h-0.5 md:h-1 bg-primary"></div>
          </div>
          
          <div className="prose prose-base sm:prose-lg max-w-none space-y-6 sm:space-y-8 font-cormorant">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-xl sm:text-2xl font-cinzel text-primary mb-!2">1. Changed your mind? No biggie</h3>
                <p className="text-base sm:text-lg">You have <strong className="text-accent">7 magical days</strong> (from the date of delivery) to decide if your Luna piece is <em>the one</em>.</p>
                <p className="text-base sm:text-lg mt-2">
                  Just tap this link and follow the sparkle trail:{' '}
                  <Link 
                    to={currentUser ? "/profile" : "/login"} 
                    className="text-accent hover:text-primary transition-colors"
                  >
                    {currentUser ? "Visit your profile" : "Login to your account"}
                  </Link>
                </p>
              </div>

              <div>
                <h3 className="text-xl sm:text-2xl font-cinzel text-primary mb-2">2. Wanna swap? Let's do it!</h3>
              ...
              <div className="bg-gray-50 p-4 sm:p-6 rounded-xl">
                <h4 className="text-lg sm:text-xl font-cinzel text-primary mb-2">Special Cases (aka No Returns Zone):</h4>
              ...
              <div className="bg-gray-50 p-4 sm:p-6 rounded-xl mt-6 sm:mt-8">
                <h4 className="text-lg sm:text-xl font-cinzel text-primary mb-2">Still confused or stuck in return-land?</h4>
                <p className="text-base sm:text-lg">We're just a message away!</p>
                <p className="text-base sm:text-lg">Email us at: <a href="mailto:jewelrybyluna.official@gmail.com" className="text-accent hover:text-primary transition-colors">jewelrybyluna.official@gmail.com</a></p>
                <p className="text-base sm:text-lg">WhatsApp: <a href="tel:9039348168" className="text-accent hover:text-primary transition-colors">90393 48168</a></p>
              </div>

              <p className="text-lg sm:text-xl text-center font-cormorant italic text-primary">Let's make your Luna experience full of sparkle – from cart to heart!</p>
            </div>
          </div>
        </div>
      </div>
